        ...
        <div class="box box-info">
         ...
         <div class="box-body">
          <div class="form-group">
            <div class="col-sm-4">
              <label for="inputEmail3" class="control-label">Slider Name</label>
              <?php echo $this->Form->input('name', array('class' => 'form-control','required','label'=>false,'placeholder'=>'Slider Name','autofocus','autocomplete'=>'off')); ?>   
            </div>
            
            
            <div class="col-sm-4">
              <label for="inputEmail3" class="control-label">Upload Image</label><span style="color:red">  Please select minimum image size 720*373px</span><br>
              <?php echo $this->Form->input('image', array('class' =>'form-control','autocomplete' => 'off','label'=>false,'type'=>'file','id'=>'fUpload','accept'=>'image/png, image/jpg, image/jpeg, image/gif','onchange'=>'checkextension()','required')); ?> 
            </div>
            ...
            <div class="col-sm-4">
              ...
              <?php echo $this->Form->input('slider_type',array('class'=>
