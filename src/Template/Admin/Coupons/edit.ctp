      ...
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php echo 'Edit Coupon'; ?></h3>
          </div>
          <?php echo $this->Form->create($editCoupon, array(
            ...
            <div class="container-fluid">
              <div class="form-group">
                <div class="col-sm-3">
                  ...
                  <?php
                  echo $this->Form->input('code', array('class' => 'longinput form-control input-medium', 'placeholder' => 'Coupon Code', 'type' => 'text', 'label' => false, 'required', 'autocomplete' => 'off', 'value' => $editCoupon['code'])); ?>
                </div>

                <!-- <div class="col-sm-3">
                  <label for="inputEmail3" class="control-label">Applicable To</label>
                  <?php
                  echo $this->Form->input('applicable_to', array('class' => 'longinput form-control input-medium', 'id' => 'applicable-to', 'type' => 'select', 'options' => $applicableTo, 'label' => false, 'required', 'autocomplete' => 'off', 'value' => $editCoupon['applicable_to'])); ?>
                </div> -->
                ...
                <div class="col-sm-3">
                  ...
                  echo $this->Form->radio(
                    'applicable_type',
                    [
                      ['value' => 'amount', 'text' => 'Amount', 'label' => false, 'class' => 'custom-radio applicatble-type', 'required', 'id' => 'amount', 'autocomplete' => 'off', $editCoupon['applicable_type'] == "amount" ? 'checked' : ''],
                      ['value' => 'percentage', 'text' => 'Percentage', 'label' => false, 'class' => 'custom-radio applicatble-type', 'required', 'id' => 'percent', 'autocomplete' => 'off', $editCoupon['applicable_type'] == "percentage" ? 'checked' : ''],
                    ]
                  );
                  ?>
                </div>
                <!-- <div class="form-group">
                    <div class="col-sm-3">
                      ...
                      echo $this->Form->radio(
                        'discount_type',
                        [
                          ['value' => 'flat', 'text' => 'Flat Discount', 'label' => false, 'class' => 'custom-radio discount-type', 'required', 'autocomplete' => 'off', $editCoupon['discount_type'] == "flat" ? 'checked' : ''],
                        ]
                      );
                      ?>
                    </div> -->
              ...
              <div class="form-group">
                ...
                <div id="amnt">
                  ...
                  <div class="col-sm-3">
                    <label for="inputEmail3" class="control-label">Maximum Discount</label>
                    <?php echo $this->Form->input('maximum_discount', array('class' => 'longinput form-control input-medium', 'type' => 'number', 'palceholder' => 'Maximum Discount', 'label' => false, 'autocomplete' => 'off', 'id' => 'maxval')); ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                <div class="col-sm-3">
                  ...
                  <?php $frmdate = date('d-m-Y', strtotime($editCoupon['valid_from'])); ?>
                  <?php
                  echo $this->Form->input('valid_from', array('class' => 'longinput form-control input-medium', 'type' => 'text', 'palceholder' => 'Valid From Date', 'label' => false, 'required', 'autocomplete' => 'off', 'readonly', 'id' => 'datepicker1', 'value' => $frmdate)); ?>
                </div>

                <div class="col-sm-3">
                  <label for="inputEmail3" class="control-label">Coupon Valid To</label>
                  <?php
                  echo $this->Form->input('valid_to', array('class' => 'longinput form-control input-medium ', 'type' => 'text', 'palceholder' => 'Valid To Date', 'label' => false, 'required', 'autocomplete' => 'off', 'readonly', 'id' => 'datepicker2', 'value' => date('d-m-Y', strtotime($editCoupon['valid_to'])))); ?>
                </div>
              </div>
              ...
              <div class="form-group">
                <!-- <div class="col-sm-3">
                      ...
                      <?php
                      echo $this->Form->input('categories[]', array('class' => 'longinput form-control input-medium', 'id' => 'categories', 'type' => 'select', 'multiple', 'options' => $categories, 'empty' => 'Select Category', 'label' => false, 'autocomplete' => 'off', 'style' => "width:100%", 'value' => $selctedcategories)); ?>
                    </div>

                    <div class="col-sm-3">
                      <label for="inputEmail3" class="control-label">Applicable Products</label>
                      <?php
                      echo $this->Form->input('products[]', array('class' => 'longinput form-control input-medium', 'id' => 'products', 'type' => 'select', 'multiple', 'options' => $products, 'empty' => 'Select Products', 'label' => false, 'autocomplete' => 'off', 'style' => "width:100%", 'value' => $selctedproducts)); ?>
                    </div> -->

                <div class="col-sm-3">
                  <label for="inputEmail3" class="control-label">Description</label>
                  <?php
                  echo $this->Form->input('description', array('class' => 'longinput form-control input-medium', 'type' => 'textarea', 'palceholder' => 'Valid To Date', 'label' => false, 'required', 'autocomplete' => 'off', 'value' => $editCoupon['description'])); ?>
                </div>
    ...
    form.addEventListener('submit', function(event) {
      ...
      if (selectedValue == 'amount') {
        if (minOrderValue == '') {
          ...
          alert('Maximum Discount Field are required');
...
<?php if ($editCoupon['applicable_type'] == "amount") { ?>
  <script>
