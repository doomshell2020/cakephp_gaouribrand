        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <?php //check path extention for PATHINFO_EXTENSION only for PNG 
              ?>
              <div class="col-sm-3">
                          ...
                          ?>
                            <div class="removecurrentworking">
                              <ul class="payment_details list-unstyled">
                                ...
                                <li class="col-sm-4">
                                  <a href="javascript:void(0);" class="delete_paymentcurrent btn remove-field btn-danger btn-block" data-val="<?php echo $current['id'] ?>"><i class="fa fa-minus-circle"></i></a>
                                </li>
                              </ul>
