          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-4">
                ...
                <?php $get_location_name = $this->Comman->get_location_list($id);
                echo $this->Form->input('location', array('class' =>
                'form-control', 'label' => false, 'options' => $locations, 'empty' => '--Select Location--', 'autofocus', 'required', 'disabled' => empty($get_location_name) ? '' : true, 'value' => $get_location_name)); ?>
              </div>
            </div>
          </div>
