...
<head>
  ...
  <link rel="icon" href="<?php echo SITE_URL; ?>images/favicoon.png" type="image/x-icon">
  ...
  <div class="page_wrapper">
    <header id="header">
      <div class="container">
        ...
        ?>
        <nav class="navbar navbar-expand-lg navbar-light "> <a class="navbar-brand" href="<?php echo SITE_URL; ?>"> <img src="<?php echo SITE_URL; ?>htdocs/gaouribrand/webroot/logo_1.png" class="img-fluid"> </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="<?php echo SITE_URL; ?>products/all">
              <button class="btn btn-outline-success my-2 my-sm-0" type="submit"> List of Products</button>
            </a>
          </div>
        </nav>
      </div>
